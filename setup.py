...
setup(
    name='G6',
    version='',
    packages=['G6', 'core', 'core.migrations', 'venv.Lib.site-packages.bson', 'venv.Lib.site-packages.pytz',
              ...
              'venv.Lib.site-packages.django.templatetags', 'venv.Lib.site-packages.gridfs',
              'venv.Lib.site-packages.pymongo', 'venv.Lib.site-packages.pip-9.0.1-py3.6.egg.pip',
